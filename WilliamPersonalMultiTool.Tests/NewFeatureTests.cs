...
namespace WilliamPersonalMultiTool.Tests
{
    ...
    public class NewFeatureTests
    {
        ...
        public void ActionsCanBeTwoWords_MoveTo()
        {
            ...
            Assert.AreEqual(ActionType.Move, actual.Actor.Action);
        ...
        public void VerbHasADefault()
        {
            ...
            Assert.AreEqual(ActionType.Size, actual.Actor.Action);
        ...
        public void TypeActor_RandomString_Letters()
        {
            ...
            Assert.AreEqual(ActionType.Type, actual.Actor.Action);
        ...
        public void RepeatActor_RepeatLast()
        {
            ...
            Assert.AreEqual(ActionType.Repeat, actual.Actor.Action);
